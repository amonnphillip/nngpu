...
class SoftmaxLayer : public Layer<SoftmaxNode, double, double, double>, public INNetworkLayer
{
protected:
	int nodeCount = 0;
	int forwardCount = 0;
	...
	int layerHeight = 0;
	int layerDepth = 0;
	std::unique_ptr<double> expHostMem;
	double* expDeviceMem;

public:
	SoftmaxLayer(SoftmaxLayerConfig* config, INNetworkLayer* previousLayer);
